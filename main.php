				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:50px;">Intelli-Ed: Higher Studies Guidance</h1>
							
							<?php
								// Check if the user is logged in, if not then redirect him to login page
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									<p class="lead white-text" style="margin-left: 5px;" ><b>Discover yourself<br>Take the test to find the perfect role for your Higher Education.</b></p>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Intelli-Ed</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Intelli-Ed</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
