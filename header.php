<head>
	...
	<body>
        ...
        <header id="header" class="transparent-nav" style="position: fixed;background-color: rgb(120, 70, 167); ; top: 0; height: 60px;">
			<div class="container">

				<div class="navbar-header">
					<!-- Logo -->
					<div class="navbar-brand">
						<a class="logo" href="main.php" style="display: flex; align-items: center; gap: 3px;">
							<img src="img/weblogo.png" alt="Logo" style="height: 900px; width: 70px;">
							<span style="font-weight: bold; color: white;">Intelli-Ed</span>
						</a>
					</div>
					<!-- /Logo -->
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								...
								<a href="http://127.0.0.1/php%20CAREERLY/check.php">Colleges</a>
						...
						<li><a href="CHECKADMINSCHOLARSHIP.php">Add Scholarships</a></li>
